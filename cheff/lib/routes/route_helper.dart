...
import 'package:shopping_app/screens/cheff/cheff_list.dart';
...
class RouteHelper {
  ...
  static const String cheff = '/cheff';
 ...
 */
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: cheff, page: () => CheffScreen()),
  ];
}

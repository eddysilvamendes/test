...
class ProductFoodDelail extends StatelessWidget {
  int pageId;
  String page;
  ProductFoodDelail({Key? key, required this.pageId, required this.page})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var productItem = Get.find<ProductController>().productList[pageId];
